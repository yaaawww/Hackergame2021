...
function gyflagh(_0x111955) {
    ...
    console.log(_0x111955);
    let _0x3b790d = _0x111955[_0x50051f(0x1a8)](_0x50051f(0x1b7));
    console.log(_0x3b790d);
    console.log(_0x50051f(0x1aa));
    if (_0x3b790d === _0x50051f(0x1aa)) return !![];
    return ![];
}

let a = "12345678901234567890123456789012";
let b =  gyflagh(a);
console.log(b);
console.log(Base16ToLong("0134c135799a7ed61a874f63dd6b162c842f51f1b115df9e96143d891d218fb7"));
console.log(Base16ToLong("6fbde674"));
console.log(Base16ToLong("819a59bf"));
console.log(Base16ToLong("a1209256"));
console.log(Base16ToLong("5b4ca2a7"));
console.log(Base16ToLong("a11dc670"));
console.log(Base16ToLong("c678681d"));
console.log(Base16ToLong("af4afb67"));
console.log(Base16ToLong("04b82f0c"));

console.log(LongToStr4("10290160461"), LongToStr4("-6991555998"));
console.log(LongToStr4("1817013865"), LongToStr4("-3196959890"));
console.log(LongToStr4("-3433073615"), LongToStr4("5896746337"));
console.log(LongToStr4("14852645681"), LongToStr4("-6824562577"));
